...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="bg-black py-16 md:py-28">
      <div
        ref={sectionRef}
      ...
      >
        <h2 className="text-xs tracking-[0.35em] uppercase text-white/40 mb-8">About Us</h2>
        <div className="space-y-5 text-sm md:text-base tracking-wide leading-relaxed text-white/70">
          ...
          <p className="text-white font-semibold uppercase tracking-[0.2em] pt-4">
